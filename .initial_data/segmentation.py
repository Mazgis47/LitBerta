...
abbreviation = ['a', 'a.k.', 'pr', 'm', 'e', 'a.s','adv','akad','aklg','akt','al', 'angl', 'apyg','aps','apskr','asist','asmv','avd','atsak',
        ...
        'kat','kg','kyš','kl','kln','kn','koresp','kpt','kr','kt','kun','l.e.p', 'liet', 'ltn','mat','med', 'mėn', 'mgr','mgnt','min','mjr',
        'mln','mlrd','mok','mst','mstl','N','nkt','ntk','nr','p','p.d','p.m.e','pav','pavad','pirm','pl','plg',
        'plk','pr.kr','prof','prok','prot','pss','pšt','pvz','r','red','rš','raj','s','sąs','sav','saviv','sekr',
        'sek', 'sen','sk','skg','skyr','skv','sp','spec','sr','st','str','stud','š.m','šnek','šv','t','t.y','t.p','techn',
        'tel','teol','tir','tūkst','up','upl','V','vad','val','ved','vet','vnt','vrš','vyr','vyresn','vs','Vt','vtv', 'vv',
        'zool','žml','žr','ž.ū','šmt']
